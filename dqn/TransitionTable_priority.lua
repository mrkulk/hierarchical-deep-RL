...
local trans_priority = torch.class('dqn.TransitionTable_priority')
...
function trans_priority:add(s, a, r, term, subgoal)
    -- print('TT:', term, r)
...
function trans_priority:add_recent_state(s, term, subgoal)
